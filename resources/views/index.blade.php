                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            <div class="badge bg-gradient-primary-to-secondary text-white mb-4 fs-6">
                                <div class="text-uppercase">Puspa Holistic Integrative Care</div>
                            </div>
                            <div class="fs-3 fw-light text-muted">Kami dapat membantu Anda untuk</div>
                            <h1 class="display-5 fw-bolder mb-5">
                                <span class="text-gradient d-inline">Menganalisis kebutuhan khusus anak secara akurat
                                    dan efektif</span>
                            </h1>
                            ...
                            <div
                                ...
                                <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder"
                                    href="{{ route('observasi.create') }}">Deteksi Sekarang!</a>
                    ...
                    <div class="col-xxl-7">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                ...
                                <img class="profile-img" src="{{ asset('assets/profile.webp') }}" alt="..." />
                                <div class="dots-1">
                                    <!-- SVG Dots-->
    ...
    <footer class="bg-white py-4 mt-auto">
        <div class="container px-5">
            <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                <div class="col-auto">
                    <div class="small m-0">Copyright &copy; {{ env('APP_NAME') }} 2025</div>
                </div>
                <div class="col-auto">
                    <span class="small" href="">{{ env('APP_AUTHOR') }}</span>
                </div>
            </div>
        </div>
    </footer>
