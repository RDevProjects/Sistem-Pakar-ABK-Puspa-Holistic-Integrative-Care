                            ...
                            <td>
                                <div class="progress">
                                    <div class="progress-bar progress-bar-custom bg-success" role="progressbar"
                                        ...
                                        aria-valuenow="{{ round($diagnosa_dipilih['value'] * 100, 2) }}" aria-valuemin="0"
                                        aria-valuemax="100">
                ...
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body table-responsive">
                            ...
                            <thead class="table-primary">
                                <tr>
                                    ...
                                    <th>MB <i class="fas fa-info-circle tooltip-info"
                                            title="Measure of beliefe (tingkat keyakinan)"></i>
                                    </th>
                                    <th>MD<i class="fas fa-info-circle tooltip-info"
                                            title="Measure of disbelief (tingkat ketidakyakinan)"></i>
                                    </th>
                                    <th>Nilai Keyakinan <i class="fas fa-info-circle tooltip-info"
                                            title="MB - MD: Selisih antara keyakinan (MB) dan ketidakyakinan (MD) pakar"></i>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                        ...
                        <small class="text-muted">
                            <i class="fas fa-info-circle"></i> MB: Keyakinan pakar bahwa gejala benar. MD: Ketidakyakinan
                            pakar terhadap gejala.
                        </small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card shadow-sm h-100">
                    ...
                    <div class="card-body table-responsive">
                        ...
                        <small class="text-muted">
                            <i class="fas fa-info-circle"></i> Nilai menunjukkan tingkat kepastian gejala berdasarkan input
                            pengguna.
                        </small>
                    </div>
                </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card shadow-sm h-100">
                    <div class="card-header bg-info">
                        <h5 class="mb-0 text-white">Certainty Factor (CF) Gabungan</h5>
                    </div>
                    <div class="card-body table-responsive">
                        <table class="table table-bordered table-striped">
                        ...
                        <small class="text-muted">
                            <i class="fas fa-info-circle"></i> CF Gabungan adalah kombinasi nilai keyakinan pakar dan input
                            pengguna.
                        </small>
                    </div>
                </div>
        ...
        <div class="card mb-4 shadow-sm">
            ...
            <div class="card-body">
                ...
                <p>
                    ...
                    <span class="fw-bold text-success fs-4">{{ round($hasil['value'] * 100, 2) }}%</span>.
                </p>
                <p class="text-muted">
