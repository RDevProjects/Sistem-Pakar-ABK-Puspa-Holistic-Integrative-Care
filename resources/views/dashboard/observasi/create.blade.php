...
<body class="bg-gray-100 p-6">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
        <h1 class="text-2xl font-bold mb-6 text-center">Form Observasi (Usia 2-5 Tahun)</h1>
        ...
        <form action="{{ route('observasi.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="kesimpulan" class="w-full p-2 border rounded">{{ old('kesimpulan') }}</textarea>
            </div>

            <button type="submit" class="bg-blue-500 text-white p-2 rounded hover:bg-blue-600">Proses
                Observasi</button>
        </form>
    </div>
</body>
